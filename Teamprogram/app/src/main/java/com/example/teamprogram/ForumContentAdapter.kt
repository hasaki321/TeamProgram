...
class ForumContentAdapter (val userList: ArrayList<String>, val contentList: ArrayList<String>): RecyclerView.Adapter<ForumContentAdapter.ForumContentViewHolder>() {
